...
//	ГрадиентВниз = ПолучитьГрадиент(Новый Цвет(0,31,255),Новый Цвет(0,255,196)  , КоличествоКадров);

	//Градиент = ПолучитьГрадиент(Новый Цвет(0,31,255), Новый Цвет(0,255,196), КоличествоКадров/2);
	//ГрадиентВниз = ПолучитьГрадиент(Новый Цвет(0,255,196),Новый Цвет(0,31,255)  , КоличествоКадров);
	//	Градиент = ПолучитьГрадиент(Новый Цвет(0,31,255), Новый Цвет(175,0,255), КоличествоКадров/2);   //Сине-фиолетовый
	//ГрадиентВниз = ПолучитьГрадиент(Новый Цвет(175,0,255),Новый Цвет(0,31,255)  , КоличествоКадров);

	//	Градиент = ПолучитьГрадиент(Новый Цвет(20,20,20), Новый Цвет(255,255,255), КоличествоКадров/2);
	//ГрадиентВниз = ПолучитьГрадиент(Новый Цвет(255,255,255),Новый Цвет(20,20,20)  , КоличествоКадров/2);
	//Градиент = ПолучитьГрадиент(Новый Цвет(0,0,0), Новый Цвет(250,250,250), КоличествоКадров);
	//ГрадиентВниз = ПолучитьГрадиент(Новый Цвет(250,250,250),Новый Цвет(0,0,0)  , КоличествоКадров);

	//Для каждого Цвет Из ГрадиентВниз Цикл
	//	Градиент.Добавить(Цвет);	
	//КонецЦикла; 
	//Для  Цвет = 1 по КоличествоКадров/4 Цикл
	//	Градиент.Вставить(0,"000000");	
	//КонецЦикла; 
